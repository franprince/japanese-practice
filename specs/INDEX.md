...
| 2026-09-05 | [unify-game-session-state](2026-09-05-unify-game-session-state/spec.md) | Unify game session state | Implemented — [PR #60](https://github.com/franprince/japanese-practice/pull/60) open; see [plan](2026-09-05-unify-game-session-state/implementation_plan.md) and [tasks](2026-09-05-unify-game-session-state/tasks.md) |
