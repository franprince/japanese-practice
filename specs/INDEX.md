...
| 2026-09-05 | [unify-game-session-state](2026-09-05-unify-game-session-state/spec.md) | Unify game session state | Implemented and verified — see [plan](2026-09-05-unify-game-session-state/implementation_plan.md) and [tasks](2026-09-05-unify-game-session-state/tasks.md) |
