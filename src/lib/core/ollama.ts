...
8. ALWAYS USE KANJI WITH FURIGANA: Whenever a word has a standard Kanji representation, you MUST use the Kanji and its reading in brackets: 漢字[かんじ]. DO NOT provide readings for Hiragana or Katakana. Only Kanji requires readings. This applies to EVERY occurrence, including verb stems (e.g., 起き[おき]).
9. FURIGANA FORMAT: Append the reading inside brackets immediately after the Kanji: 漢字[かんじ]. DO NOT use spaces before the bracket (Incorrect: 学生 [がくせい], Correct: 学生[がくせい]).
